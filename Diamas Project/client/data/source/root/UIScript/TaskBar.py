					...
					(
						{
							...
							"images" :
							(
								ROOT + "TaskBar/mall/00.sub",
								ROOT + "TaskBar/mall/01.sub",
								ROOT + "TaskBar/mall/02.sub",
								ROOT + "TaskBar/mall/03.sub",
								ROOT + "TaskBar/mall/04.sub",
								ROOT + "TaskBar/mall/05.sub",
								ROOT + "TaskBar/mall/06.sub",
								ROOT + "TaskBar/mall/07.sub",
								ROOT + "TaskBar/mall/08.sub",
								ROOT + "TaskBar/mall/09.sub",
								ROOT + "TaskBar/mall/11.sub",
								ROOT + "TaskBar/mall/12.sub",
								ROOT + "TaskBar/mall/13.sub",
								ROOT + "TaskBar/mall/14.sub",
								ROOT + "TaskBar/mall/15.sub",
								ROOT + "TaskBar/mall/16.sub",
							)
						},
