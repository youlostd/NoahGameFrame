	...
	(
		{
			...
			(
				## Title
				{
					...
					"color" : "yellow",
					"title" : uiScriptLocale.GEMSHOP_TITLA,
				...
				## �����ð�
				{ "name":"BuyRefreshTimeName", "type":"text", "x":BOARD_WIDTH / 2 - 10, "y":35, "text": uiScriptLocale.GEMSHOP_LEFTTIME, "horizontal_align":"center" },
				{ "name":"BuyRefreshTime", "type":"text", "x" : (BOARD_WIDTH / 2) + 48, "y":35, "text":"10:10", "horizontal_align":"center" },
				...
				{ "name":"slot_1_price", "type":"text", "x" : 19+28, "y":100, "text":"999", "horizontal_align":"center" },
				{ "name":"slot_1_Icon", "type":"image", "x":19, "y":100, "image":GEM_ICON, },	
				
				{ "name":"slot_2_price", "type":"text", "x" : 64+28, "y":100, "text":"2", "horizontal_align":"center" },
				{ "name":"slot_2_Icon", "type":"image", "x":64, "y":100, "image":GEM_ICON, },	
				
				{ "name":"slot_3_price", "type":"text", "x" : 109+28, "y":100, "text":"33", "horizontal_align":"center" },
				{ "name":"slot_3_Icon", "type":"image", "x":109, "y":100, "image":GEM_ICON, },	
								
				{ "name":"slot_4_price", "type":"text", "x" : 19+28, "y":158, "text":"4", "horizontal_align":"center" },
				{ "name":"slot_4_Icon", "type":"image", "x":19, "y":158, "image":GEM_ICON, },	
				
				{ "name":"slot_5_price", "type":"text", "x" : 64+28, "y":158, "text":"5", "horizontal_align":"center" },
				{ "name":"slot_5_Icon", "type":"image", "x":64, "y":158, "image":GEM_ICON, },	
				
				{ "name":"slot_6_price", "type":"text", "x" : 109+28, "y":158, "text":"6", "horizontal_align":"center" },
				{ "name":"slot_6_Icon", "type":"image", "x":109, "y":158, "image":GEM_ICON, },	
				
				{ "name":"slot_7_price", "type":"text", "x" : 19+28, "y":216, "text":"7", "horizontal_align":"center" },
				{ "name":"slot_7_Icon", "type":"image", "x":19, "y":216, "image":GEM_ICON, },	
				
				{ "name":"slot_8_price", "type":"text", "x" : 64+28, "y":216, "text":"8", "horizontal_align":"center" },
				{ "name":"slot_8_Icon", "type":"image", "x":64, "y":216, "image":GEM_ICON, },	
				
				{ "name":"slot_9_price", "type":"text", "x" : 109+28, "y":216, "text":"9", "horizontal_align":"center" },
