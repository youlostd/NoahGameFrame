    ...
    "children":
        [
            ...
            },
            {
                ...
                "type": "button",
                "x": SCREEN_WIDTH - 50 - 72,
                "y": SCREEN_HEIGHT - 100 - 25 - 55 - 67 - 67,
                "default_image": "d:/ymir work/ui/game/windows/btn_bigplus_up.sub",
                "over_image": "d:/ymir work/ui/game/windows/btn_bigplus_over.sub",
                "down_image": "d:/ymir work/ui/game/windows/btn_bigplus_down.sub",
...
window["children"] = window["children"] + [
    {
        "name": "DungeonRejoinButton",
        "type": "button",
        "x": SCREEN_WIDTH - 50 - 72 - 72,
        "y": SCREEN_HEIGHT - 100 - 25 - 55 - 67 - 67,
		"default_image": "d:/ymir work/ui/game/windows/btn_bigplus_up.sub",
		"over_image": "d:/ymir work/ui/game/windows/btn_bigplus_over.sub",
		"down_image": "d:/ymir work/ui/game/windows/btn_bigplus_down.sub",
        ...
        "children":
            (
                {
                    "name": "DungeonRejoinButtonName",
                    "type": "text",
                    "x": 0,
                    "y": 40,
                    "text": uiScriptLocale.GAME_DUNGEON_REJOIN,
                    "r": 1.0, "g": 1.0, "b": 1.0, "a": 1.0,
					"horizontal_align": "center"
