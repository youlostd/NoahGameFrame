...
float g_fAlphaValue = 1.9f;
float4x4 shadowTexMatrix;
float3x3 g_specularMat;
bool g_specularEnable = true;
float g_specularPower = 1.9f;
...
float4 GrannyPSOpacity ( VS_OUT In ) : COLOR
{
	...
	float4 outColor = baseColor * In.Diffuse;
...
technique Rigid
{
    ...
    pass Opacity
    {
        ...
        AlphaRef = 0;
        VertexShader = compile vs_3_0 RigidVS();
        PixelShader = compile ps_3_0 GrannyPSOpacity();
