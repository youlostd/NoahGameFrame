...
quest spider_dungeon_3floor_boss begin
	...
	--2, 던전 끝 시간.
		when spider_end_timer.server_timer with game.get_event_flag("spider_dead"..get_channel_id()) == 0 begin  --
			warp_all_in_area_to_area(217, 315*100, 495*100, 425*100, 625*100, 217, 175*100, 476*100, 175*100, 476*100)
			...
			purge_area(217, 315*100, 495*100, 425*100, 625*100)
		end
		...
		when 30130.chat.gameforge.spider_dungeon_3floor_boss.title_1 begin
			say(gameforge.spider_dungeon_3floor_boss.say_1)
		end
	end

	state step1 begin
		when 20011.chat.gameforge.spider_dungeon_3floor_boss.title_2 with is_test_server() begin   --테스트용
			set_state(start)
			say(gameforge.spider_dungeon_3floor_boss.say_2)
		end
		...
		when 20355.chat.gameforge.spider_dungeon_3floor_boss.title_4 begin   --경비대장에게 말을 걸어 퀘스트를 시작한다.
			
			say_title(c_mob_name(20355)) 
			----"12345678901234567890123456789012345678901234567890"|
			say(gameforge.spider_dungeon_3floor_boss.say_4)
			set_state( step2 )
		end
	end
	...
	state step2 begin --비석에 탁본을 뜨러 가야한다.
		...
		-----------퀘스트편지2------------
		when letter begin
			send_letter(gameforge.spider_dungeon_3floor_boss.title_5)
		...
		when button or info begin
			say_title(gameforge.spider_dungeon_3floor_boss.title_5)
			say(gameforge.spider_dungeon_3floor_boss.say_5)
			say("")
		end

		when 30130.chat.gameforge.spider_dungeon_3floor_boss.title_5 begin
			target.delete("__TARGET__")
			
			say_title(pc.getname())
			----"12345678901234567890123456789012345678901234567890"|
			say(gameforge.spider_dungeon_3floor_boss.say_5_1)
			set_state(step3)
		end
		...
		when 20355.chat.gameforge.spider_dungeon_3floor_boss.title_4 begin
			
			say_title(c_mob_name(20355))
			----"12345678901234567890123456789012345678901234567890"|
			say(gameforge.spider_dungeon_3floor_boss.say_6)
		end
	...
	state step3 begin --탁본을 떴으니 경비에게 돌아간다.
		...
		when letter begin
			send_letter(gameforge.spider_dungeon_3floor_boss.title_7)
		...
		when button or info begin
			say_title(gameforge.spider_dungeon_3floor_boss.title_7)
			say(gameforge.spider_dungeon_3floor_boss.say_7)
			say("")
		end
		
		--을두지를 선택하면 해당 퀘스트에 관련된 대화를 나눌 수 있다.
		when 20355.chat.gameforge.spider_dungeon_3floor_boss.title_7 begin
			say_title(c_mob_name(20355))
			say(gameforge.spider_dungeon_3floor_boss.say_7_1)
			set_state(step4)
		end
	...
	state step4 begin  --을두지에게 탁본을 맡기자.
		...
		when button or info begin
			say_title(gameforge.spider_dungeon_3floor_boss.title_7)
			say(gameforge.spider_dungeon_3floor_boss.say_7_2)
			say("")
		end
		
		when 20011.chat.gameforge.spider_dungeon_3floor_boss.title_7 begin
			target.delete("__TARGET__")
			
			say_title(c_mob_name(20011))
			say(gameforge.spider_dungeon_3floor_boss.say_7_3)
			say("")
	...
	state step5 begin  --경비한테 편지 배달
		...
		when button or info begin
			say_title(gameforge.spider_dungeon_3floor_boss.title_8)
			say(gameforge.spider_dungeon_3floor_boss.say_8)
			say("")
		end
		
		when 20355.chat.gameforge.spider_dungeon_3floor_boss.title_9 begin
			target.delete("__TARGET__")
			say_title(c_mob_name(20355))
			----"12345678901234567890123456789012345678901234567890"|
			say(gameforge.spider_dungeon_3floor_boss.say_9)
			say("")
		...
		when 20011.chat.gameforge.spider_dungeon_3floor_boss.title_7 begin
			say_title(c_mob_name(20011))
			say(gameforge.spider_dungeon_3floor_boss.say_7_4)
			say("")
		end
	...
	state step6 begin --경비는 나만 일시킨다. 을두지와 상의하자.
		...
		when letter begin
			send_letter(gameforge.spider_dungeon_3floor_boss.title_9)
		...
		when button or info begin
			say_title(gameforge.spider_dungeon_3floor_boss.title_9)
			say(gameforge.spider_dungeon_3floor_boss.say_9)
			say("")
		end

		--을두지를 선택하면 해당 퀘스트에 관련된 대화를 나눌 수 있다.
		when 20011.chat.gameforge.spider_dungeon_3floor_boss.title_9 begin
			target.delete("__TARGET__")
			say_title(c_mob_name(20011))
			say(gameforge.spider_dungeon_3floor_boss.say_9_1)
	...
	state boss_ok begin  -- 열쇠를 만들수 있게 된 최종상태. 이제부터 거미굴 보스룸에 입장할 수 있다.
		...
		when	20011.chat.gameforge.spider_dungeon_3floor_boss.title_9 begin
			say_title(c_mob_name(20011))
			say(gameforge.spider_dungeon_3floor_boss.say_9_2)
			wait()
			...
			if pc.count_item(30025) > 0 and pc.count_item(30056) > 0 and pc.count_item(30057) > 0 and pc.count_item(30058) > 0 and pc.count_item(30059) > 0 and pc.count_item(30326) > 0 then
				say_title(c_mob_name(20011))
				say(gameforge.spider_dungeon_3floor_boss.say_9_3)
				...
				if math.random(1,2000) <= 1000 then
					say(gameforge.spider_dungeon_3floor_boss.say_9_4)
					pc.give_item2(30324, 1)
				else
					say(gameforge.spider_dungeon_3floor_boss.say_9_5)
				end
			else
				say_title(c_mob_name(20011))
				say(gameforge.spider_dungeon_3floor_boss.say_9_6)
			end
		end
		...
		when 30130.chat.gameforge.spider_dungeon_3floor_boss.title_1 begin
			if game.get_event_flag("spider_lair_ongoing_"..get_channel_id()) == 1 then
				...
				if party.get_leader_pid() == game.get_event_flag("spider_lair_leader_"..get_channel_id()) then
					...
					if  starttime +  lair_enter_wait_time >= current_time  and party.get_leader_pid() == game.get_event_flag("spider_lair_leader_"..get_channel_id()) and game.get_event_flag("spider_lair_ongoing_"..get_channel_id()) == 1 then
						say(gameforge.spider_dungeon_3floor_boss.say_10) -- 테스트용
						...
						say(gameforge.spider_dungeon_3floor_boss.say_11) -- 테스트용
						return
					end
				else
					local remain_time = game.get_event_flag("spider_lair_end_time_"..get_channel_id() ) - get_global_time()
					say(gameforge.spider_dungeon_3floor_boss.say_12)
			...
			elseif  pc.getqf("retry_limit_time") > get_global_time() then
				...
				say(gameforge.spider_dungeon_3floor_boss.say_14)
				say(""..access_limit..locale.spider_dungeon_3floor_boss.say_15)
				return
			elseif party.is_leader()   then
				 if false == pc.can_warp() then
					  say(gameforge.spider_dungeon_3floor_boss.say_16)
					  return
				 end
				if pc.count_item(30324) > 0 then
					say(gameforge.spider_dungeon_3floor_boss.say_17)
					local warp = select(gameforge.confirm,gameforge.cancel)
					if warp == 1 then
					...
					say(gameforge.spider_dungeon_3floor_boss.say_18)
					return
				end
			else --리더 아니다.
				say(gameforge.spider_dungeon_3floor_boss.say_19)
				return
			end
	...
	state inLair begin
		...
		when login  begin 
			if pc.getqf("firstIn") == 1  and party.get_leader_pid() == game.get_event_flag("spider_lair_leader_"..get_channel_id()) then
				pc.setqf("firstIn",0)
			elseif pc.get_map_index() == 217 and pc.getx() >= 315 and pc.getx() <= 425 and pc.gety() >= 495 and  pc.gety() <= 625 then 
				pc.warp(217, 447, 78)
		...
		when 2092.kill begin --대왕거미 죽임
			...
			notice_in_map(gameforge.spider_dungeon_3floor_boss.say_20)
		end
		...
		when 30327.use with pc.get_map_index() == 217 and pc.getx() >= 315 and pc.getx() <= 425 and pc.gety() >= 495 and  pc.gety() <= 625 begin
