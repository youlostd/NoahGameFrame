...
quest owl_dungeon begin
	...
	--QUEST FUNCTIONS
		...
		function create_dungeon()
			...
			server_timer("owl_dungeon_45min_left", 15*60, d.get_map_index())
		end
		...
		when OWL_GHOST.chat.gameforge.owl_dungeon._90_npcChat  with not owl_dungeon.is_owled() begin
			...
			say("")
			say_title(c_mob_name(9225))
			say(gameforge.owl_dungeon._100_say)
			wait()
			addimage(25, 10, "owl_dungeon00.tga")
			addimage(238, 75, "owlghost.tga")
			say("")
			...
			if select(gameforge.infected_garden_quest._220_select, gameforge.infected_garden_quest._230_select) == 1then
				owl_dungeon.check_enter()
			end
		end
		
		when OWL_GHOST.chat.gameforge.owl_dungeon._120_npcChat with owl_dungeon.is_owled() and d.getf("owl_level_1") == 1 begin
			local settings = owl_dungeon.settings()
			...
			say("")
			say_title(c_mob_name(9225))
			say(gameforge.owl_dungeon._130_say)
			say_reward(gameforge.owl_dungeon._140_sayReward)
			wait()
			owl_dungeon.get_regens(1)
			npc.purge()
			d.notice("Owl dungeon: Kill all owls")
			d.setf("totem", 1)
			loop_timer("owldungeon_1thfloor", 3);
		...
		when owldungeon_1thfloor.timer begin
			...
			if (d.count_monster() == 0) then
				...
				d.notice("Owl dungeon: You have killed all monsetrs.");
				d.notice("Owl dungeon: Now place %s to the totem and destroy it!", c_item_name(settings.key_1thfloor));
			else
				d.notice("Owl dungeon: You still have to kill %d mobs to get a key.", d.count_monster());
			end
		end
		...
		when FIRST_TOTEM.take with item.get_vnum() == 30707 and owl_dungeon.is_owled() and d.getf("totem") == 1 and d.getf("owl_level_1") == 1 begin
			...
			d.notice("Owl dungeon: Something happened...")
			d.notice("Owl dungeon: This key doesn't works. Next %s are coming!!" , c_mob_name(712))
			d.notice("Owl dungeon: Kill them fast!!")
			d.setf("owl_level_1", 2)
			owl_dungeon.get_regens(2)
			loop_timer("owldungeon_1bthfloor", 3);
		end
		...
		when owldungeon_1bthfloor.timer begin
			...
			if (d.count_monster() == 0) then
				...
				d.notice("Owl dungeon: You have killed all monsetrs.");
				d.notice("Owl dungeon: Now place %s to the totem and destroy it!", c_item_name(settings.key_1bthfloor))
			else
				d.notice("Owl dungeon: You still have to kill %d mobs to get a key.", d.count_monster())
			end
		end
		...
		when OWL_GHOST.chat.gameforge.owl_dungeon._220_npcChat  with owl_dungeon.is_owled() and d.getf("owl_level_1") == 2 begin
			local settings = owl_dungeon.settings()
				addimage(25, 10, "owl_dungeon01.tga")
				addimage(238, 75, "owlghost.tga")
				say("")
				...
				say_title(c_mob_name(9225))
				if party.is_party() and not party.is_leader() then
					say(gameforge.owl_dungeon._230_say)
				else
					say(gameforge.owl_dungeon._240_say)
		...
		when OWL_GHOST.chat.gameforge.owl_dungeon._250_npcChat  with owl_dungeon.is_owled() and d.getf("owl_level_1") == 3 begin
			local settings = owl_dungeon.settings()
				addimage(25, 10, "owl_dungeon02.tga")
				addimage(238, 75, "owlghost.tga")
				say("")
				say("")
				say("")
				...
				if party.is_party() and not party.is_leader() then
					...
					say(gameforge.owl_dungeon._260_say)
					wait()
					npc.purge()
					d.setf("owl_level_1", 4)
					d.spawn_mob(OWL_METIN1, settings["owl_metin_pos"][1], settings["owl_metin_pos"][2])
					d.notice("Owl dungeon: Destroy the metin in 2 minutes!!")
					d.notice("Owl dungeon: If you won't destroy it in 2 minutes,")
					d.notice("Owl dungeon: you will be out of the dungeon.")
		...
		when kill with owl_dungeon.is_owled() and not npc.is_pc() and npc.get_race() == OWL_METIN1 and d.getf("owl_level_1") == 4 begin
			d.notice("Owl dungeon: You succesfuly destroyed the metin!")
			d.notice("Owl dungeon: Monsters are coming!!")
			d.notice("Owl dungeon: Kill them all!")
		...
		when kill with owl_dungeon.is_owled() and not npc.is_pc() and npc.get_race() == OWL_METIN1 and d.getf("owl_level_1") == 7 begin
			if d.getf("metinstone_second") == 1 then
				d.notice("Owl dungeon: 4 metin stones left!")
				d.setf("metinstone_second", 2)
			elseif d.getf("metinstone_second") == 2 then
				d.notice("Owl dungeon: 3 metin stones left!")
				d.setf("metinstone_second", 3)
			elseif d.getf("metinstone_second") == 3 then
				d.notice("Owl dungeon: 2 metin stones left!")
				d.setf("metinstone_second", 4)
			elseif d.getf("metinstone_second") == 4 then
				d.notice("Owl dungeon: 1 metin stone left!")
				d.setf("metinstone_second", 5)
			elseif d.getf("metinstone_second") == 5 then
				d.notice("Owl dungeon: You've destroyed all metin stones.")
				d.notice("Owl dungeon: The gate to next floor is open!")
		...
		when OWL_GHOST.chat.gameforge.owl_dungeon._340_npcChat with owl_dungeon.is_owled() and d.getf("owl_level_1") == 9 begin
			local settings = owl_dungeon.settings()
				...
				if party.is_party() and not party.is_leader() then
					...
					say(gameforge.owl_dungeon._350_say)
					wait()
					npc.purge()
		...
		when OWL_HURT.chat.gameforge.owl_dungeon._360_npcChat  with owl_dungeon.is_owled() and d.getf("owl_level_1") == 9 begin
			local settings = owl_dungeon.settings()
				addimage(25, 10, "owl_dungeon03.tga")
				addimage(190, 150, "owl_hurt.tga")
				say("")
				say("")
				say("")
				say_title(c_mob_name(9227))
				if party.is_party() and not party.is_leader() then
					say_reward(gameforge.owl_dungeon._230_say)
				else
					say(gameforge.owl_dungeon._370_say)
					wait()
					d.setf("owl_level_1", 10)
					local metinStonePos = {{214, 597}};
					for index = 1, table.getn(metinStonePos), 1 do
						local randomNumber = math.random(1, table.getn(metinStonePos));
						
						d.spawn_mob(OWL_METIN2, metinStonePos[randomNumber][1], metinStonePos[randomNumber][2]);
		...
		when kill with owl_dungeon.is_owled() and not npc.is_pc() and npc.get_race() == OWL_METIN2 and d.getf("owl_level_1") == 10 begin
			...
			if (npc.get_vid() == d.get_unique_vid("real_metin_stone")) then
				d.notice("Owl dungeon: You've found first ingredient!")
				d.notice("Owl dungeon: Be careful! Owls are coming!")
				d.notice("Owl dungeon: Kill them all!")
				...
				d.notice("Owl dungeon: There was nothing in this metin.")
			end
		end
		...
		when kill with owl_dungeon.is_owled() and not npc.is_pc() and npc.get_race() == SURAN and d.getf("owl_level_1") == 12 begin
			...
			d.notice("Owl dungeon: Suran was defeated!");
			d.notice("Owl dungeon: You get another ingredient!");
			d.setf("owl_level_1", 13)
			d.spawn_mob(OWL_GHOST, settings["owl_ghost_pos"][5][1], settings["owl_ghost_pos"][5][2])
		end
		
		when OWL_GHOST.chat.gameforge.owl_dungeon._410_npcChat  with owl_dungeon.is_owled() and d.getf("owl_level_1") == 13 begin
			local settings = owl_dungeon.settings()
			...
			local randomNumber = math.random(1, table.getn(FeatherPos));
				...
				if party.is_party() and not party.is_leader() then
					...
					say(gameforge.owl_dungeon._420_say)
					wait()
		...
		when OWL_HURT.take with item.get_vnum() == 30712 and owl_dungeon.is_owled() and d.getf("owl_level_1") == 16 begin
			...
			timer("wave_spawn", 7)
			timer("wave_kill", 1)
			d.notice("Owl dungeon: Lira is alive thanks to you!")
			d.notice("Owl dungeon: Final floor is open now!")
		end

		when OWL_GHOST.chat.gameforge.owl_dungeon._530_npcChat  with owl_dungeon.is_owled() and d.getf("owl_level_1") == 17 begin
			local settings = owl_dungeon.settings()
				addimage(25, 10, "owl_dungeon00.tga")
				addimage(238, 75, "owlghost.tga")
				say("")
				...
				if party.is_party() and not party.is_leader() then
					...
					say(gameforge.owl_dungeon._540_say)
					say_reward(gameforge.owl_dungeon._550_sayReward)
					wait()
					npc.purge()
		...
		when kill with owl_dungeon.is_owled() and not npc.is_pc() and npc.get_race() == OWL_STATUE and d.getf("owl_level_1") == 18 begin
			if d.getf("kill_statue") == 1 then
				d.notice("Owl dungeon: 3 statues has left!")
				d.setf("kill_statue", 2)
			elseif d.getf("kill_statue") == 2 then
				d.notice("Owl dungeon: 2 statues has left!")
				d.setf("kill_statue", 3)
			elseif d.getf("kill_statue") == 3 then
				d.notice("Owl dungeon: 1 statue has left!")
				d.setf("kill_statue", 4)
			elseif d.getf("kill_statue") == 4 then
				d.notice("Owl dungeon: All statues was destroyed!")
				d.notice("Owl dungeon: Monsters are coming!")
				d.notice("Owl dungeon: Kill them all!")
		...
		when kill with owl_dungeon.is_owled() and not npc.is_pc() and npc.get_race() == SURAN and d.getf("owl_level_1") == 20 begin
			...
			elseif d.getf("suran_kill") == 2 then
				d.setf("suran_kill", 0)
				d.notice("Owl dungeon: Perfect! Be prepared!")
				d.notice("Owl dungeon: Ru-Taig is coming!!!")
				d.setf("owl_level_1", 21)
				timer("wave_spawn", 5)
			end
		end
		
		when kill or party_kill with owl_dungeon.is_owled() and not npc.is_pc() and npc.get_race() == RU_TAIG and d.getf("owl_level_1") == 21 begin
			owl_dungeon.clear_owldungeon()
			d.notice("Owl dungeon: You succesfully finished the dungeon!")
			d.notice("Owl dungeon: You will be teleported in 2 minutes")
			notice_all(gameforge.owl_dungeon._190_notice_all1 .. pc.get_name() .. gameforge.owl_dungeon._190_notice_all2) --- GLOBAL NOTICE
		...
		when wave_kill.timer begin
			...
			if d.getf("owl_level_1") == 5 then
				if (d.count_monster() == 0) then
					...
					d.notice("Owl dungeon: You have killed all monsetrs!");
					d.notice("Owl dungeon: Watch out! Stronger monsters are coming!");
					timer("wave_spawn", 3)
				else
					d.notice("Owl dungeon: You still have to kill %d mobs to move on.", d.count_monster())
				end
			elseif d.getf("owl_level_1") == 6 then
				if (d.count_monster() == 0) then
					...
					d.notice("Owl dungeon: You have killed all monsetrs!");
					d.notice("Owl dungeon: Destroy all metin stones!");
					timer("wave_spawn", 3)
				else
					d.notice("Owl dungeon: You still have to kill %d mobs to move on.", d.count_monster())
				end
			elseif d.getf("owl_level_1") == 11 then
				if (d.count_monster() == 0) then
					...
					d.notice("Owl dungeon: Suran is here!");
					d.notice("Owl dungeon: Defeat him!");
					timer("wave_spawn", 3)
				else
					d.notice("Owl dungeon: You still have to kill %d mobs to move on.", d.count_monster())
				end
			...
			elseif d.getf("owl_level_1") == 19 then
				if (d.count_monster() == 0) then
					...
					d.notice("Owl dungeon: Great job!");
					d.notice("Owl dungeon: Be careful now!");
					d.notice("Owl dungeon: 2 Surans are coming!");
					d.notice("Owl dungeon: Kill them!");
					timer("wave_spawn", 3)
				else
					d.notice("Owl dungeon: You still have to kill %d mobs to move on.", d.count_monster())
				end
		...
		when wave_spawn.timer begin
			...
			elseif d.getf("owl_level_1") == 21 then
				d.spawn_mob(RU_TAIG, settings["rutaig_pos"][1], settings["rutaig_pos"][2])
			end
		end
		...
		when owl_dungeon_45min_left.server_timer begin
			if d.select(get_server_timer_arg()) then
				d.notice("Owl dungeon: 30 minutes left!")
				server_timer("owl_dungeon_30min_left", 15*60, d.get_map_index())
			end
		end
		
		when owl_dungeon_30min_left.server_timer begin
			if d.select(get_server_timer_arg()) then
				d.notice("Owl dungeon: 15 minutes left!")
				server_timer("owl_dungeon_15min_left", 5*60, d.get_map_index())
			end
		end
		
		when owl_dungeon_15min_left.server_timer begin
			if d.select(get_server_timer_arg()) then
				d.notice("Owl dungeon: 10 minutes left!")
		...
		when owl_dungeon_5min_left.server_timer begin
			if d.select(get_server_timer_arg()) then
				d.notice("Owl dungeon: 5 minutes left!")
				d.notice("Owl dungeon: Hurry up!!")
				server_timer("owl_dungeon_1min_left", 4*60, d.get_map_index())
			end
		end
		
		when owl_dungeon_1min_left.server_timer begin
			if d.select(get_server_timer_arg()) then
				d.notice("Owl dungeon: 1 minute left!")
				d.notice("Owl dungeon: You are almost failed!!")
				server_timer("owl_dungeon_0min_left", 60, d.get_map_index())
			end
		end
		...
		when final_owl.server_timer begin
			if d.select(get_server_timer_arg()) then
				d.notice("Owl dungeon: Time has expired!")
				d.notice("Owl dungeon: You failed!")
				owl_dungeon.clear_owldungeon()
		...
		when final_succes_owl.server_timer begin
			if d.select(get_server_timer_arg()) then
				d.notice("Owl dungeon: You will be teleported out of dungeon!")
				owl_dungeon.clear_owldungeon()
				d.set_warp_location(41, 9694, 2786)
			end
