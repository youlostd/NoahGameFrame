		...
		['MISSIONS'] = {
			{
				...
				['REWARDTEXT'] = "- Amulett der ew. Liebe (3h)[ENTER]- 20000 Yang[ENTER]- 10000 Erfahrung",
				...
				['REWARD'] = {
					['ITEM'] = {
						['ITEMVNUM'] = {71186,0}, -- Wenn kein Item dann {0} bei beidem
						['ITEMCOUNT'] = {1,0},
						},
					['YANG'] = 20000,
					['EXP'] = 10000,
			...
			},
			{
				...
				['REWARDTEXT'] = "- 10x Gegenstand Verzaubern[ENTER]- 20000 Yang[ENTER]- 10000 Erfahrung",
				...
				['REWARD'] = {
					['ITEM'] = {
						['ITEMVNUM'] = {71084,0}, -- Wenn kein Item dann {0} bei beidem
						['ITEMCOUNT'] = {10,0},
						},
					['YANG'] = 20000,
					['EXP'] = 10000,
			...
			-- NEUE D-QUEST PLATZ
			{
				...
				['QUESTTEXT'] = "Sammle 20 Wüstensand![ENTER]Viel Glueck dabei!", -- [ENTER] -> Neue Zeile im Text
				['REWARDTEXT'] = "- Ebenholzarmband[ENTER]- 3x Diamant",
				
				['QUESTICON'] = 14100,
				
				['COLLECT'] = {
					['MOBVNUM'] = { {2102} }, -- es koennen mehrere Mobs das "Item" droppen
					['ITEMNAME'] = {"Wüstensand"},
					['NEED'] = {20},
					['DROPCHANCE'] = {25},
				},
		...
		
			{
				...
				['QUESTTEXT'] = "Sammle 25 Säbel![ENTER]Viel Glueck dabei!", -- [ENTER] -> Neue Zeile im Text
			...
			
			{
				...
				['COLLECT'] = {
					['MOBVNUM'] = {8506}, -- es koennen mehrere Mobs das "Item" droppen
					['ITEMNAME'] = {"Armschutz"},
					['NEED'] = {25},
					['DROPCHANCE'] = {20},
				},
				...
				['REWARD'] = {
					['ITEM'] = {
						['ITEMVNUM'] = {16207,27993}, -- Wenn kein Item dann {0} bei beidem
						['ITEMCOUNT'] = {1,1},
						},
					['YANG'] = 300000,
					['EXP'] = 0,
			...
			
			{
				...
				['REWARDTEXT'] = "- Elixier des Forschers",
				
				['QUESTICON'] = 76020,
				
				['COLLECT'] = {
					['MOBVNUM'] = {634,654}, -- es koennen mehrere Mobs das "Item" droppen
					['ITEMNAME'] = {"Zauberstab"},
					['NEED'] = {10},
					['DROPCHANCE'] = {25},
				},
			...
			
			{
				...
				['QUESTTEXT'] = "Sammle 15 Proben von den Eisgolem[ENTER] Viel Glueck dabei!", -- [ENTER] -> Neue Zeile im Text
			...
			
			{
				...
				['QUESTTEXT'] = "Sammle 25x Gift von den Klauengiftspinnen[ENTER] und Soldatengiftspinnen im Spinnendungeon[ENTER] Viel Glueck dabei!", -- [ENTER] -> Neue Zeile im Text
			...
			
			{
				...
				['REWARDTEXT'] = "- Elixier des Forschers[ENTER] - 1x Weiße Perle",
			...
			
			{
				...
				['REWARDTEXT'] = "- 1x Magischer Stein[ENTER] - 1x Weiße Perle[ENTER] - 1x Blaue Perle[ENTER] - 1x Rote Perle[ENTER] - 25x Segen des Drachen",
