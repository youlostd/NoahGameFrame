...
curl "https://api.telegram.org/bot1019998125:AAFdDFWWGjHTOGT93VRGUxfEa9Ru600Q9QA/sendMessage?chat_id=-1001408529110&text=Server%20ReleaseNativeBuild%20started"
...
cmake -DCMAKE_BUILD_TYPE=Release -DMETIN2_BUILD_NATIVE=ON -DMETIN2_VENDOR_PATH=$VENDOR_DIR -G Ninja
