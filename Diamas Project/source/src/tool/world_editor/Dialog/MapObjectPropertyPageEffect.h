#ifndef METIN2_TOOL_WORLDEDITOR_DIALOG_MAPOBJECTPROPERTYPAGEEFFECT_HPP
#define METIN2_TOOL_WORLDEDITOR_DIALOG_MAPOBJECTPROPERTYPAGEEFFECT_HPP
...
protected:
	...
	TPropertyEffect m_propertyEffect;
