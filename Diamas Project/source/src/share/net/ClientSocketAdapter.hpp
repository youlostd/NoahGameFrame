#ifndef METIN2_NET_CLIENTSOCKETADAPTER_HPP
#define METIN2_NET_CLIENTSOCKETADAPTER_HPP
...
template <class T>
class ClientSocketAdapter : public T
{
	public:
		template <class... Args>
		ClientSocketAdapter(boost::asio::io_service& ioService,
		                    Args&&... args);
...
#include "ClientSocketAdapter-impl.hpp"
