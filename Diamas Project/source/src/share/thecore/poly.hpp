#ifndef METIN2_THECORE_POLY_HPP
#define METIN2_THECORE_POLY_HPP
...
class CPoly
{
	...
	protected:
	int my_irandom(double start, double end) const;
	double my_frandom(double start, double end) const;
