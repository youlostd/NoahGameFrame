...
class RumiWaitingPage(ui.ScriptWindow):
	...
	def __LoadWindow(self):
		...
		try:
			...
			logging.exception("MiniGameRumiWaitingPage.LoadWindow.LoadObject")
		...
		try:
			...
			logging.exception("MiniGameRumiWaitingPage.LoadWindow.BindObject")
	...
	def __ClickStartButton(self):
		...
		if None == self.start_question_dialog:
			...
			self.start_question_dialog.SetText(localeInfo.MINI_GAME_RUMI_START_QUESTION.format(30000, 1) )
	...
	def __StartAccept(self):
		...
		appInst.instance().GetNet().SendMiniGameRumiStart()
	...
	def Show(self):
		...
		event.SetRestrictedCount(self.descIndex, 60) #47 mainline �� development �� ��Ʈü�� �޶�
...
class RumiGamePage(ui.ScriptWindow):
	...
	def __LoadWindow(self):
		...
		try:
			...
			logging.exception("MiniGameRumiGamePage.LoadWindow.LoadObject")
		...
		try:
			...
			logging.exception("MiniGameRumiGamePage.LoadWindow.BindObject")
	...
	def __AcceptExit(self):
		...
		appInst.instance().GetNet().SendMiniGameRumiExit()
	...
	def __AcceptDiscard(self):
		...
		appInst.instance().GetNet().SendMiniGameRumiHandCardClick(False, self.discard_index)
		self.discard_index = -1
	...
	def LButtonClickDeck(self):
		...
		appInst.instance().GetNet().SendMiniGameRumiDeckCardClick()
	...
	def LButtonClickHand(self, index):
		...
		appInst.instance().GetNet().SendMiniGameRumiHandCardClick(True, index)
	...
	def RButtonClickHand(self, index):	
		...
		if self.confirm_window_on == True:
			...
			appInst.instance().GetNet().SendMiniGameRumiHandCardClick(False, index)
	...
	def LButtonClickField(self, index):
		...
		appInst.instance().GetNet().SendMiniGameRumiFieldCardClick(index)
...
class MiniGameRumi(ui.Window):
	...
	def __LoadWindow(self):
		...
		try:
			...
			logging.exception("MiniGameRumi.LoadWindow")
