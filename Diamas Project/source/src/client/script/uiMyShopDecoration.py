...
class MyShopDecoration(ui.ScriptWindow):
    ...
    def Open(self):
        ...
        appInst.instance().GetNet().SendMyShopDecoState(True)
    ...
    def Close(self):
        ...
        appInst.instance().GetNet().SendMyShopDecoState(False)
    ...
    def __CreateEvent(self):
        ...
        self.GetChild("MyShopTitleBar").SetCloseEvent(self.Close)

        self.NextBtn.SetEvent(self.UseNextButton)
        self.CancelBtn.SetEvent(self.Close)
        self.PrevBtn.SetEvent(self.UsePrevButton)
        self.CompleteBtn.SetEvent(self.UseCompleteButton)

        for i in xrange(len(self.ModelBtnList)):
            self.ModelBtnList[i].SetEvent(Event(self.SelectButton, i))
    ...
    def UseNextButton(self):
        ...
        self.TitleBar.SetTitleName(uiScriptLocale.MYSHOP_DECO_SELECT_TITLE)
    ...
    def UsePrevButton(self):
        ...
        self.PrevBtn.Hide()
        self.CompleteBtn.Hide()
        self.TitleBar.SetTitleName(uiScriptLocale.MYSHOP_DECO_SELECT_MODEL)
        self.ViewMode = self.MODE_MODEL_VIEW
    ...
    def UseCompleteButton(self):
        ...
        appInst.instance().GetNet().SendMyShopDecoSet(self.TitleType, self.PolyVnum)
    ...
    def __LoadModelInfo(self):
        ...
        self.ShopTitleList.append(DecoObj(uiScriptLocale.MYSHOP_DECO_DEFAULT, ui.ThinBoardOld(), self.RenderTarget))
