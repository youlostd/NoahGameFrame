...
NUMBER_RES_MAX	= 14	# ���� ���ҽ� max
NUMBER_PAGE_MAX = 2		# ��2������
SHOW_NUMBER_COUNT = 8	# ���������� 8�� ����
DEFAULT_SHOW_NUMBER_MAX = 14	# �� 14������ ����
...
class MiniGameAttendance(ui.ScriptWindow):
	...
	def __LoadWindow(self):
		...
		try:
			...
			loggging.exception("MiniGameAttendance.LoadWindow")
		...
		try:
			...
			logging.exception("MiniGameAttendance.LoadWindow.BindObject")
			
		appInst.instance().GetNet().SendMiniGameAttendanceRequestRewardList()
		appInst.instance().GetNet().SendMiniGameAttendanceRequestData( player.ATTENDANCE_DATA_TYPE_DAY )
		appInst.instance().GetNet().SendMiniGameAttendanceRequestData( player.ATTENDANCE_DATA_TYPE_MISSION_CLEAR )
		appInst.instance().GetNet().SendMiniGameAttendanceRequestData( player.ATTENDANCE_DATA_TYPE_GET_REWARD )
		appInst.instance().GetNet().SendMiniGameAttendanceRequestData( player.ATTENDANCE_DATA_TYPE_SHOW_MAX )
	...
	def __RewardAccept(self):
		appInst.instance().GetNet().SendMiniGameAttendanceButtonClick(self.cur_attendance_number)
		self.__RewardCancel()
