...
void CGraphicColorInstance::BlendColorReference(uint64_t blendTime, const CGraphicColor &c_rDstColor)
{
...
void CGraphicColorInstance::Update()
{
    ...
    uint64_t elapsedTime = curTime - m_baseTime;
...
uint64_t CGraphicColorInstance::GetCurrentTime()
{
