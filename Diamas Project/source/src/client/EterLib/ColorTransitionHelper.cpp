...
bool CColorTransitionHelper::Update()
{
    ...
    uint64_t dwCurTime = GetTickCount64();
    uint64_t dwElapsedTime = dwCurTime - m_dwStartTime;
    ...
    if ((1.0f == fpercent) && (fCurAlpha == m_fDstAlpha) && (fCurRed == m_fDstRed) && (fCurGreen == m_fDstGreen) && (
            fCurBlue == m_fDstBlue))
    {
