...
#define AssertLog(str)	SPDLOG_ERROR(str); assert(!str)
...
{
	const T PI = T(boost::math::constants::pi<float>());
...
BOOST_FORCEINLINE bool CopyStringSafe(char(&dst)[N], const std::string& src)
{
