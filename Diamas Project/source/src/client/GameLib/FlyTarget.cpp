...
void IFlyTargetableObject::AddFlyTargeter(CFlyTarget* pTargeter)
{
	m_FlyTargeterSet.insert(pTargeter);
}

void IFlyTargetableObject::RemoveFlyTargeter(CFlyTarget* pTargeter)
{
	m_FlyTargeterSet.erase(pTargeter);
}

void IFlyTargetableObject::ClearFlyTargeter()
{
	BOOST_FOREACH(const auto& tgt, m_FlyTargeterSet)
		tgt->NotifyTargetClear();
