...
void CActorInstance::SetDiffuseRenderOnly()
{
    m_iRenderMode = RENDER_MODE_DIFFUSE_ONLY;
}
void CActorInstance::SetNormalRenderMode()
{
    m_iRenderMode = RENDER_MODE_DIFFUSE_ONLY;
}
...
void CActorInstance::__BlendAlpha_Update()
{
    ...
    {
        float fCurAlpha = m_kBlendAlpha.m_fBaseAlpha + (m_kBlendAlpha.m_fDstAlpha - m_kBlendAlpha.m_fBaseAlpha) *
