...
bool DetectCollisionDynamicZCylinderVSDynamicZCylinder(const CDynamicSphereInstance &c_rSphere1,
                                                       const CDynamicSphereInstance &c_rSphere2)
{
    ...
    IntersectLineSegments(c_rCylinder1.v3LastPosition, c_rCylinder1.v3Position,
                          ...
                          vA, vB);
    return (Vector3::DistanceSquared(vA, vB) <= rsq);
}

bool DetectCollisionDynamicSphereVSDynamicSphere(const CDynamicSphereInstance &c_rSphere1,
                                                 const CDynamicSphereInstance &c_rSphere2)
{
    ...
    Vector3 da=c_rSphere1.v3Position-c_rSphere1.v3LastPosition;
    Vector3 db=c_rSphere2.v3Position-c_rSphere2.v3LastPosition;
    Vector3 n;
    ...
    Vector3 p=c_rSphere2.v3Position - c_rSphere1.v3LastPosition;
  ...
  */
    ...
    // NOTE : AABB 체크 할 것
    ///////////////////////////////////////////////////////////////////////////////////////////////
    Vector3 v3Distance = c_rSphere1.v3Position - c_rSphere2.v3Position;
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////
    Vector3 v3LastDistance = c_rSphere1.v3LastPosition - c_rSphere2.v3LastPosition; // A
    Vector3 v3Advance = c_rSphere1.v3Advance - c_rSphere2.v3Advance;                // B
...
{
	Vector3 v3SpherePosition = c_rSphere.v3Position - c_rPlane.v3Position;
	Vector3 v3SphereLastPosition = c_rSphere.v3LastPosition - c_rPlane.v3Position;
	...
	{
		Vector3 v3QuadPosition1 = c_rSphere.v3Position - c_rPlane.v3QuadPosition[0];
		Vector3 v3QuadPosition2 = c_rSphere.v3Position - c_rPlane.v3QuadPosition[3];
...
{
	Vector3 v3Distance = c_rSphere.v3Position - c_rSphereData.v3Position;
	...
	//Vector3 v3LastDistance = c_rSphere.v3LastPosition - c_rSphereData.v3Position;
...
bool DetectCollisionDynamicSphereVSStaticCylinder(const CDynamicSphereInstance & c_rSphere, const TCylinderData & c_rCylinderData)
{
	...
	Vector3 v3curDistance = c_rSphere.v3Position - c_rCylinderData.v3Position;
	float fDistance = D3DXVec3Length(&v3curDistance);

	if (fDistance <= c_rSphere.fRadius + c_rCylinderData.fRadius)
		return true;

	//Vector3 v3lastDistance = c_rSphere.v3LastPosition - c_rCylinderData.v3Position;
...
bool DetectCollisionDynamicSphereVSStaticPlane(const TSphereInstance & c_rSphere, const TPlaneData & c_rPlane)
{
	...
	if (fPosition1 * fPosition2 < 0.0f || fabs(fPosition1) <= c_rSphere.fRadius)
	{
		...
		Vector3 v3CollisionPosition = c_rSphere.v3LastPosition + c_rSphere.v3Advance * fT;
		Vector3 v3QuadPosition1 = v3CollisionPosition - c_rPlane.v3BeginPosition;
		Vector3 v3QuadPosition2 = v3CollisionPosition - c_rPlane.v3EndPosition;
