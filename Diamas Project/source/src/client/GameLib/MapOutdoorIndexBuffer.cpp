...
{
    for (auto uci = 0; uci < TERRAINPATCH_LODMAX; ++uci)
    {
		m_IndexBuffer[uci] = ENGINE_INVALID_HANDLE;
	}
    ...
    for (uci = 0; uci < TERRAINPATCH_LODMAX; ++uci)
    {
        ...
        count[uci] = 0;
        count2[uci] = 0;
        m_IndexBuffer[uci] = Engine::GetDevice().CreateIndexBuffer(dwIndexNum);

        if (!isValid(m_IndexBuffer[uci]))
            SPDLOG_ERROR("CMapOutdoor::SetIndexBuffer() IndexBuffer Create Error");
    }
    ...
    for (uci = 0; uci < TERRAINPATCH_LODMAX; ++uci)
    {
        ...
        void* pIndices     = Engine::GetDevice().LockIndexBuffer(m_IndexBuffer[uci]);
        if (!pIndices)
        {
            SPDLOG_ERROR("CMapOutdoor::SetIndexBuffer() IndexBuffer Unlock Error");
            continue;
        }
            
        memcpy(pIndices, m_pwaIndices[uci], count[uci] * sizeof(uint16_t));
        Engine::GetDevice().UnlockIndexBuffer(m_IndexBuffer[uci]);
        delete [] m_pwaIndices[uci];
        m_pwaIndices[uci] = NULL;
    }
}

void CMapOutdoor::ADDLvl1TL(uint16_t *pIndices, uint16_t &rwCount, const uint16_t &c_rwCurCount,
...
void CMapOutdoor::ADDLvl1T(uint16_t *pIndices, uint16_t &rwCount, const uint16_t &c_rwCurCount,
                           const uint8_t &c_rucNumLineWarp)
{
    pIndices[rwCount++] = c_rwCurCount;
    pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp * 2;
...
void CMapOutdoor::ADDLvl1TR(uint16_t *pIndices, uint16_t &rwCount, const uint16_t &c_rwCurCount,
                            const uint8_t &c_rucNumLineWarp)
{
    pIndices[rwCount++] = c_rwCurCount;
    pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp * 2;
...
void CMapOutdoor::ADDLvl1L(uint16_t *pIndices, uint16_t &rwCount, const uint16_t &c_rwCurCount,
                           const uint8_t &c_rucNumLineWarp)
{
    pIndices[rwCount++] = c_rwCurCount;
    pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp;
...
void CMapOutdoor::ADDLvl1R(uint16_t *pIndices, uint16_t &rwCount, const uint16_t &c_rwCurCount,
                           const uint8_t &c_rucNumLineWarp)
{
    pIndices[rwCount++] = c_rwCurCount;
    pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp * 2;
...
void CMapOutdoor::ADDLvl1BL(uint16_t *pIndices, uint16_t &rwCount, const uint16_t &c_rwCurCount,
                            const uint8_t &c_rucNumLineWarp)
{
    pIndices[rwCount++] = c_rwCurCount;
    pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp;
...
void CMapOutdoor::ADDLvl1B(uint16_t *pIndices, uint16_t &rwCount, const uint16_t &c_rwCurCount,
                           const uint8_t &c_rucNumLineWarp)
{
    pIndices[rwCount++] = c_rwCurCount;
    pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp * 2;
...
void CMapOutdoor::ADDLvl1BR(uint16_t *pIndices, uint16_t &rwCount, const uint16_t &c_rwCurCount,
                            const uint8_t &c_rucNumLineWarp)
{
    pIndices[rwCount++] = c_rwCurCount;
    pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp * 2;
...
void CMapOutdoor::ADDLvl1M(uint16_t *pIndices, uint16_t &rwCount, const uint16_t &c_rwCurCount,
                           const uint8_t &c_rucNumLineWarp)
{
    pIndices[rwCount++] = c_rwCurCount;
    pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp * 2;
...
void CMapOutdoor::ADDLvl2TL(uint16_t *pIndices, uint16_t &rwCount, const uint16_t &c_rwCurCount,
                            const uint8_t &c_rucNumLineWarp)
{
...
void CMapOutdoor::ADDLvl2T(uint16_t *pIndices, uint16_t &rwCount, const uint16_t &c_rwCurCount,
                           const uint8_t &c_rucNumLineWarp)
{
...
void CMapOutdoor::ADDLvl2TR(uint16_t *pIndices, uint16_t &rwCount, const uint16_t &c_rwCurCount,
                            const uint8_t &c_rucNumLineWarp)
{
    ADDLvl1T(pIndices, rwCount, c_rwCurCount, c_rucNumLineWarp);
...
void CMapOutdoor::ADDLvl2L(uint16_t *pIndices, uint16_t &rwCount, const uint16_t &c_rwCurCount,
                           const uint8_t &c_rucNumLineWarp)
{
...
void CMapOutdoor::ADDLvl2R(uint16_t *pIndices, uint16_t &rwCount, const uint16_t &c_rwCurCount,
                           const uint8_t &c_rucNumLineWarp)
{
...
void CMapOutdoor::ADDLvl2BL(uint16_t *pIndices, uint16_t &rwCount, const uint16_t &c_rwCurCount,
                            const uint8_t &c_rucNumLineWarp)
{
    ADDLvl1L(pIndices, rwCount, c_rwCurCount, c_rucNumLineWarp);
...
void CMapOutdoor::ADDLvl2B(uint16_t *pIndices, uint16_t &rwCount, const uint16_t &c_rwCurCount,
                           const uint8_t &c_rucNumLineWarp)
{
    pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp * 2;
    pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp * 2 + 2;
...
void CMapOutdoor::ADDLvl2BR(uint16_t *pIndices, uint16_t &rwCount, const uint16_t &c_rwCurCount,
                            const uint8_t &c_rucNumLineWarp)
{
...
void CMapOutdoor::ADDLvl2M(uint16_t *pIndices, uint16_t &rwCount, const uint16_t &c_rwCurCount,
                           const uint8_t &c_rucNumLineWarp)
{
    pIndices[rwCount++] = c_rwCurCount;
    pIndices[rwCount++] = c_rwCurCount + c_rucNumLineWarp * 4;
