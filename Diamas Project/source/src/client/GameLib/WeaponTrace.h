#ifndef METIN2_CLIENT_GAMELIB_WEAPONTRACE_H
#define METIN2_CLIENT_GAMELIB_WEAPONTRACE_H
...
class CWeaponTrace : public CGraphicBase
{
    /*
    public:
...
#endif /* METIN2_CLIENT_GAMELIB_WEAPONTRACE_H */
